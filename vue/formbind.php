  ...
  <div class="main-wrapper">
    <article>
      <section>
        ...
        <div class="frame4">
          <b>point!</b><br>
          ・type="range"のスライダーでは0から255迄の範囲の数値を入力使用ですがHTMLの仕様上でinput要素からの入力値は文字列型のため、.number飾飾子をつけて数値型へ変換が必要。<br>
          ・カラーパレットとスライダーのどちらか変更したときにもう一方の値を更新するため、ウォッチャを使ってデータの監視を行う。<br>
